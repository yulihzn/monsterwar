package com.mw.components.avatar.main;
...
import com.mw.components.avatar.model.PixelIndexModel;
import com.mw.ui.widget.FloatRectPixmap;
...
public class Avatar {
    ...
    private class AvatarSettings {
        ...
        public Array<com.mw.components.avatar.model.PixelAnimModel> list = new Array<com.mw.components.avatar.model.PixelAnimModel>();
        private com.mw.components.avatar.part.PlayerPart playerPart;
        ...
        public void init() {
            ...
            playerPart = new com.mw.components.avatar.part.PlayerPart();
        }
        public void addAnimFile(String internalFile){
            ...
            Json json = new Json();
            com.mw.components.avatar.model.PixelAnimModel model = json.fromJson(com.mw.components.avatar.model.PixelAnimModel.class, text);
            list.add(model);
        }
