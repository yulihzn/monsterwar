...
/**
 * Created by yuli.he on 2017/9/12.
 */
...
public class Rect {
     ...
     * @return
     */
    public boolean isIntersect(Rect rect1, Rect rect2) {
        return isIntersect(rect1, rect2.left, rect2.top, rect2.right, rect2.bottom);
    }
     ...
     * @return
     */
    public boolean isIntersect(Rect rect1, int left, int top, int right, int bottom) {
        int nMaxLeft = 0;
        int nMaxTop = 0;
        int nMinRight = 0;
        int nMinBottom = 0;
        ...
        if (rect1.right <= right) {
            nMinRight = rect1.right;
        } else {
            nMinRight = right;
        }
        // Get the min bottom.
        if (rect1.bottom <= bottom) {
            nMinBottom = rect1.bottom;
        } else {
            nMinBottom = bottom;
        }
